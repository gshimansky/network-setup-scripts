...
echo MACHINE 1
ssh -F $sc1 tctestvms-1 sudo -E ./network-setup-scripts/reconfigure.sh ./network-setup-scripts/lv/e1000/vlan-nat/middle.sh
echo MACHINE 2
ssh -F $sc2 tctestvms-2 sudo -E ./network-setup-scripts/reconfigure.sh ./network-setup-scripts/lv/e1000/vlan-nat/server.sh
